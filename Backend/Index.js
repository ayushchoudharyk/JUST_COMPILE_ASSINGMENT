...
mongoose.connect(
  'mongodb+srv://AyushkChoudhary:<MsETifSIAWkiOAPE>@cluster0.xxmlv9s.mongodb.net/?retryWrites=true&w=majority',
  { useNewUrlParser: true, useUnifiedTopology: true }
);

app.get('/', function (req, res) {
  res.json('Hello Test! Im ayushchoudharyk is a blog website');
});
